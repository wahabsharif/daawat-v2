...
const NavBar: React.FC = () => {
  return (
    <nav className="fixed z-50 bg-white/30 backdrop-blur-md text-dark dark:bg-black/30 dark:text-light uppercase w-full shadow-lg transition-colors duration-300 hidden md:block">
      <TopBar />
